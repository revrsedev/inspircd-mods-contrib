...
/// $ModDesc: Adds city and country information to WHOIS using the MaxMind database and it's usermode +y.
...
private:
    ...
    GeoLiteMode geolite_mode;    // User mode +y for controlling geolocation visibility
